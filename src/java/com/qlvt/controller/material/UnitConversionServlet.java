...
import com.qlvt.dao.unit.UnitConversionDAO;
import com.qlvt.dao.unit.UnitDAO;
...
import com.qlvt.model.UnitConversion;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (action) {
            ...
            case "edit":
                ...
                request.setAttribute("unitConversion", uc);
                request.setAttribute("units", units);
                request.setAttribute("materials", materials);
            ...
            case "confirmDelete":
                ...
                request.setAttribute("material", materialsDAO.getMaterialsById(ucToDelete.getMaterialId()));
