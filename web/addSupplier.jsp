            ...
            <div class="sidebar pe-4 pb-3">
                <nav class="navbar bg-light navbar-light">
                    ...
                    <div class="navbar-nav w-100">
                        <a href="board.jsp" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="fa fa-laptop me-2"></i>Supplier</a>
                            <div class="dropdown-menu bg-transparent border-0">
                                <a href="${pageContext.request.contextPath}/suppliercontroller" class="dropdown-item">Supplier List</a>
                                <a href="${pageContext.request.contextPath}/addSupplier.jsp" class="dropdown-item active">Add Supplier</a>
...
<div class="content">
    ...
    <div class="bg-light rounded p-4">
        ...
        <form action="${pageContext.request.contextPath}/addsupplier" method="get">
