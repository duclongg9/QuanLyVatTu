<%-- 
    Document   : createExportRequest
    Created on : 2 Jul 2025, 12:43:04
    Author     : Dell-PC
--%>
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                <h6 class="mb-4">Create New Export Request</h6>
<!-- Form lọc vật tư (GET) -->
<form method="get" action="CreateRequestExport" class="row g-3 mb-4">
    <div class="col-md-4">
...
<form method="post" action="CreateRequestExport">
...
<form method="post" action="CreateRequestExport" class="mt-4">
    ...
    <button type="submit" class="btn btn-primary">Create Export Request</button>
