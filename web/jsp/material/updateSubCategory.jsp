<%-- 
    ...
    Created on : 30 Jun 2025, 06:41:49
    Author     : Dell-PC
--%>
...
<%
    model.SubCategory sc = (model.SubCategory) request.getAttribute("subCategory");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="content d-flex flex-column min-vh-100">
        ...
        <div class="container-fluid pt-4 px-4 flex-grow-1">
            <div class="bg-light rounded p-4">
                <h4 class="mb-4">Update Sub Category</h4>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="categoryMaterialId" name="categoryMaterialId" class="form-select" required>
                            <c:forEach var="c" items="${categories}">
                                <option value="${c.id}" ${c.id == sc.categoryMaterialId.id ? 'selected' : ''}>${c.category}</option>
                            </c:forEach>
                        </select>
                    </div>
                    <div class="mb-3">
